...
public class Employee implements java.io.Serializable {
	...
	public Employee(int id, Employee employee, String lastName,
			...
			Set<Territory> territorieses, Set<Order> orders,
	...
	public String toString() {
		return "Employee [id=" + id + ", employee="
				+ employee + ", lastName=" + lastName + ", firstName="
				+ firstName + ", title=" + title + ", titleOfCourtesy="
				+ titleOfCourtesy + ", birthDate=" + birthDate + ", hireDate="
				+ hireDate + ", address=" + address + ", city=" + city
				+ ", region=" + region + ", postalCode=" + postalCode
				+ ", country=" + country + ", homePhone=" + homePhone
				+ ", extension=" + extension + ", photo=" + photo + ", notes="
				+ notes + ", photoPath=" + photoPath + ", territorieses="
				+ territorieses + ", orders=" + orders + ", employees="
				+ employees + "]";
	}
